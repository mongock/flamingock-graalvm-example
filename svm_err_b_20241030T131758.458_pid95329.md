...
```java
java.lang.RuntimeException: Failed to register class for reflection: io.flamingock.changes.ACreateCollection
	at io.flamingock.graalvm.RegistrationFeature.beforeAnalysis(RegistrationFeature.java:24)
